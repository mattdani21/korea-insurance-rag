...
- [x] Add chunk-level citation chips polish in the UI (base landed in cdba94e) — chips shipped with the filter dropdown; answer card shows "filtered to: <doc>"
- [x] Write the portfolio case study: architecture (fastembed e5-large → numpy cosine → DeepSeek), eval numbers, geo-blocking lesson — `docs/CASE_STUDY.md`
- [ ] Share the demo link + case study on LinkedIn and in applications to Korean insurers/fintech/actuarial vendors — needs the hosted demo (M3)
